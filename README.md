...
![Main Menu Web](./user_guide/main_menu_no_campaign.png)

## Keyboard Bindings
![Keyboard Bindings](./user_guide/keyboard_bind.png)
...
![Dogfight Menu](./user_guide/bot_counts.png)

## Campaign Menu
From this menu you may select a mission to play
![Campaign Menu](./user_guide/mission_select_screen.png)

## Mission Start
From this menu you may start a mission \
A user may click the camera to cycle through the plane selection \
A user may click the yellow or purple "easy" button to cycle through bot difficulties
![Campaign Menu](./user_guide/mission_start_screen.png)
...
![Sound Menu](./user_guide/sound_menu.png)

## Extra Settings Menu
![Extra Settings Menu](./user_guide/extra_settings_menu.png)

## Gameplay

### Dogfight Alone
This image shows what the game looks like if one decides to select a fighter plane and spawn in
![A Human Fighter Plane](./user_guide/human_fighter.png)
...
![Test Mode](./user_guide/test_mode.png)

### Game Zoom
1/8x zoom
![1/8x zoom](./user_guide/eigth_zoom.png)
1/4x zoom
![1/4x zoom](./user_guide/quarter_zoom.png)
1/2x zoom
![1/2x zoom](./user_guide/half_zoom.png)
1x zoom
...
### Radar & Gun Heat UI
Fighter Radar
![Fighter Radar](./user_guide/friend_enemy_radar.png)

Bomber Radar
![Bomber Radar](./user_guide/bomber_blue_dot_gun_levels.png)

Spectator Radar
![Spectator Radar](./user_guide/spectator_radar.png)

Radar Zoomed In
![Radar Zoomed In](./user_guide/radar_zoom_in.png)

Radar Zoomed Out
![Radar Zoomed Out](./user_guide/radar_zoom_out.png)

### Dogfight
Playing as a fighter in a big dogfight
![Playing as a fighter in a big dogfight](./user_guide/big_dogfight_fighter.png)

Playing as a bomber in a big dogfight
![Playing as a bomber in a big dogfight](./user_guide/big_dogfight_bomber.png)

Playing as a spectator in a big dogfight
![Playing as a spectator in a big dogfight](./user_guide/big_dogfight_spectator.png)

Dogfight End Screen \
This screen informs the user which team won the Dogfight and the kills obtained by various uses & classes of bot
![Dogfight End Screen](./user_guide/end_screen_dogfight.png)

### Campaign
In a Campaign misson, attacking planes have the task of protecting their bomber
![Plane cluster](./user_guide/campaign_cluster.png)

In a Campaign misson, bombers are tasked with blowing up buildings. These are defended by defender fighter planes
![Buildings](./user_guide/buildings.png)

Some visual effects appear when buildings blow up
![buildings blowing up](./user_guide/buildings_blowing_up.png)

When all buildings are destroyed OR all bombers are dead, the mission ends
![mission end](./user_guide/campaign_attacker_win.png)